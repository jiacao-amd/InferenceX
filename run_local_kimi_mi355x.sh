#!/usr/bin/env bash
# =============================================================================
# Run Kimi-K2.5 benchmark directly inside a MI355X Docker container.
...
echo "======================================================="
echo " Kimi-K2.5 Benchmark - MI355X"
echo "======================================================="
echo "  MODEL          : $MODEL"
echo "  TP             : $TP"
...
bash benchmarks/single_node/kimik2.5_${PRECISION}_mi355x.sh
